const config = {
    ...
    users: {
        ownerId: 'OWNER ID', // The bot owner ID, which is you.
        developers: ['YOUR ID', 'DEV ID'] // The bot developers, remember to include your account ID with the other account IDs.
    },
